...
def prepare_tokenizer(args):
    ...
    tokenizer = BertTokenizerFast(args.vocab_file, model_max_length=config.model_max_length)
    return tokenizer
...
def prepare_model(args):
    ...
    if args.hetseq_state_dict != '':
        ...
        model.load_state_dict(torch.load(args.hetseq_state_dict, map_location='cpu'))
