...
class DataTrainingArguments:
    ...
    # **YD**
    extension_file: Optional[str] = field(
        default=None,
        metadata={"help": "local data processing file"},
    )
    ...
    def __post_init__(self):
        if self.dataset_name is None and self.train_file is None and self.validation_file is None and self.test_file is None:
            ...
            if self.train_file is not None:
                ...
                # **YD** add txt support
                assert extension in ["csv", "json", "txt"], "`train_file` should be a csv or a json or a txt file."
            elif self.validation_file is not None:
                # **YD** add txt support
                extension = self.validation_file.split(".")[-1]
                assert extension in ["csv", "json", "txt"], "`validation_file` should be a csv or a json or a txt file."
            else:
                # **YD** add txt support
                extension = self.test_file.split(".")[-1]
                assert extension in ["csv", "json", "txt"], "`test_file` should be a csv or a json or a txt file."
            """
            pass
...
def main():
    ...
    train_dataset.set_format(type=train_dataset.format["type"], columns=tmp_columns)
